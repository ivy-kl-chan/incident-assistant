...
- **Stories [4](story-4-1a-incidents-post-get-list.md)–[6](story-6-1a-incident-lifecycle-transitions.md)** — **1a** incident HTTP surface and error paths to normalize under RFC 7807 and **`openapi-1a.yaml`**.

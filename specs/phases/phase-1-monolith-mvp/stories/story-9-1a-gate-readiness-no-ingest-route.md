...
- **Core 1a feature stories** as required for your **1a** exit definition (typically **Stories [1](story-1-1a-app-scaffold-actuator.md)–[8](story-8-1a-container-packaging.md)** for app + packaging).
- **[Story 18](story-18-1a-pr-ci-docker-for-testcontainers.md)** — default **PR CI** must run Testcontainers (e.g. **`FlywayV1BaselineIntegrationTest`**) so **1a** DB integration is proven in CI (see **§4 Spec References**).

...
- **Stories [1](story-1-1a-app-scaffold-actuator.md)–[7](story-7-1a-problem-details-openapi.md)** (or the subset the team treats as **1a** feature-complete) — image and compose build on a working **1a** app; coordinate README overlap with **[Story 9](story-9-1a-gate-readiness-no-ingest-route.md)**.

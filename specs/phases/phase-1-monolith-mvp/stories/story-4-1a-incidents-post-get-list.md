...
- **Coordination with [Story 5](story-5-1a-incidents-patch-etag-concurrency.md)** — **`ETag` on `GET` by id** must be implemented in **Story 4** or immediately in **Story 5** before closing **1a** (see **§14 Implementation Notes**).
